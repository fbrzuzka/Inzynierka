...
public class GPIOController {
    ...
    /*
    final GpioPinDigitalOutput pin0 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_00, "pin0", PinState.HIGH);
    ...
    public GPIOController() {
        ...
        pin8.setShutdownOptions(true, PinState.HIGH);
        pin9.setShutdownOptions(true, PinState.HIGH);
         */
